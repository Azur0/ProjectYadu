...
class LocationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $numbers = array("52", "49", "158", "7A", "11", "2", "41", "402B", "105", "12a", "5223", "19");
        $codes = array("5232NJ", "5241BK", "9752BN", "1791HJ", "8011BJ", "5473AX", "1017GB", "3059XT", "3012AG", "4811XK", "5223DJ", "5211JN");
        $routes = array("Herven", "Raadhuisstraat", "Achterhorst", "Vogelenzang", "Pannekoekendijk", "Monseigneur van Oorschotstraat", "Siciliëboulevard", "Coolsingel", "Sint Annastraat", "Onderwijsboulevard", "Onderwijsboulevard", "Hooge Steenweg");
        $localities = array("'s-Hertogenbosch", "Rosmalen", "Haren", "Den Burg", "Zwolle", "Heeswijk Dinther", "Rotterdam", "Breda", "'s-Hertogenbosch", "'s-Hertogenbosch", "'s-Hertogenbosch", "'s-Hertogenbosch");
