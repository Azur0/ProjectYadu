    ...
    <form action="/events/{{$data['event']->id}}" method="POST">
        ...
        <div class="date">
            ...
            <div class="description">
                <input id="date" name="startDate" type="datetime-local" value="{{ $data['event']->startDate }}" required>
        ...
        <div>
            ...
            <div class="description">
                <input type="text" id="title" name="activityName" placeholder="Titel"
                    oninput="update_counter_title(this)" maxlength="30" required value="{{ $data['event']->eventName }}">
        ...
        <div>
            ...
            <div class="description">
                <input type="number" name="numberOfPeople" min="1" max="25" value="{{ $data['event']->numberOfPeople }}">
