...
Route::get('admin/images/categroy/edittagpicture/{id}', 'Management\ImagesController@edittagpicture')->name('imagescontroller.edittagpicture')->middleware('auth', 'isAdmin');
